...
let
val x1 = rank2int(card_rank(list_head(cs)))
val x2 = rank2int(card_rank(list_head(list_tail(cs))))
val x3 = rank2int(card_rank(list_head(list_tail(list_tail(cs)))))
val x4 = rank2int(card_rank(list_head(list_tail(list_tail(list_tail(cs))))))
val x5 = rank2int(card_rank(list_head(list_tail(list_tail(list_tail(list_tail(cs)))))))


in


if (x1 = x2) andalso (x2 = x3) andalso (x3 = x4) andalso (x4 = x5)then false 
else if (x1 = x2) andalso (x3 = x4) andalso (x4 = x5)then true 
else if (x1 = x2) andalso (x2 = x3) andalso (x4 = x5) then true
else false
